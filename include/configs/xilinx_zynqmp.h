...
#define SD_BOOT_ENV \
        "sdboot=mmcinfo && fatload mmc 1 10000000 image.ub && bootm 10000000 \0"
#endif

#if defined(CONFIG_QSPI_BOOT)
#define QSPI_BOOT_ENV \
        "qspiboot=run mmc_args; sf probe 0 && sf read 10000000 a00000 1300000 && bootm 10000000 \0" \ 
	"mmc_args=setenv bootargs console=ttyPS0,115200 root=/dev/mmcblk0p1 rw earlyprintk rootfstype=ext4 rootwait devtmpfs.mount=1 clk_ignore_unused \0" 
#endif
